...
@dataclass
class XFTConfig(TrainingArguments):
    r"""
    Configuration class for the [`XFTTrainer`].

    Only the parameters specific to XFT training are listed here. For details on other parameters, refer to the
    ...
    Parameters:
        ...
        model_init_kwargs (`str`, `dict[str, Any]` or `None`, *optional*, defaults to `None`):
            ...
            argument of the [`XFTTrainer`] is provided as a string.
        ...
        delta: (`float`, *optional*, defaults to `None`):
            Delta value for the upper clipping bound in two-sided XFT. Recommended to be > 1 + epsilon. This method was introduced in the [INTELLECT-2 tech report](https://huggingface.co/papers/2505.07291).
        ...
        scale_rewards (`bool`, *optional*, defaults to `True`):
            ...
            applied. The [Dr. XFT paper](https://huggingface.co/papers/2503.20783) recommends not scaling the rewards,
        ...
        loss_type (`str`, *optional*, defaults to `"bnpo"`):
            ...
            - `"XFT"`: Aggregates token-level losses by normalizing over sequence length. Not recommended due to
            ...
            - `"bnpo"`: Aggregates token-level losses by normalizing number of active token in the local batch.
                ...
                `per_device_train_batch_size==1`, the loss is equivalent to the XFT loss.
            - `"dr_XFT"`: Aggregates token-level losses by normalizing with a global constant. This method was
                introduced in the [Dr. XFT paper](https://huggingface.co/papers/2503.20783) to eliminate length bias.
        ...
        use_liger_loss (`bool`, *optional*, defaults to `False`):
            Whether to use the Liger XFT loss.
    ...
    # Parameters that control the data preprocessing
    # The default value remove_unused_columns is overwritten from the parent class, because in XFT we usually rely on
    ...
    delta: Optional[float] = field(
        default=None,
        metadata={
            "help": "If set to a float value (e.g., 2.0), enables the upper clipping bound in two-sided XFT loss. If None (default), the standard XFT clipping is used. Recommended to be > 1 + epsilon when enabled."
        },
    )
    ...
    scale_rewards: bool = field(
        ...
        metadata={
            ...
            "scaling is applied. The Dr. XFT paper recommends not scaling the rewards, as scaling by the standard "
    ...
    loss_type: str = field(
        default="bnpo",
        metadata={
            "help": "Specifies the loss formulation to use. Supported values are `XFT`, `bnpo`, and `dr_XFT`. "
            "`'XFT'`: Aggregates token-level losses by normalizing over sequence length. Not recommended due to "
            "length bias—this approach tends to prefer shorter completions with positive advantages and longer ones "
            "with negative advantages. "
            "`'bnpo'`: Aggregates token-level losses by normalizing number of active token in the local batch. "
            ...
            "`per_device_train_batch_size==1`, the loss is equivalent to the XFT loss. "
            "`'dr_XFT'`: Aggregates token-level losses by normalizing with a global constant. This method was "
            "introduced in the Dr. XFT paper to eliminate length bias. The value of the constant corresponds to "
    ...
    use_liger_loss: bool = field(
        default=False,
        metadata={"help": "Whether to use the Liger XFT loss."},
    )
    ...
    def __post_init__(self):
        ...
        if self.num_generations < 2:
            raise ValueError(
                "XFT requires at least 2 generations per prompt to calculate the advantages. You provided "
        ...
        if self.delta is not None and self.use_liger_loss:
            raise ValueError("Liger loss does not support two-sided XFT loss yet.")
